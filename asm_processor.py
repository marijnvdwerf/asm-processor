...
from processor.utils.constants import SLOW_CHECKS, SHN_UNDEF, SHN_ABS, STT_FUNC, MIPS_DEBUG_ST_STATIC, MIPS_DEBUG_ST_STATIC_PROC, MIPS_DEBUG_ST_FILE, MIPS_DEBUG_ST_STRUCT, MIPS_DEBUG_ST_UNION, MIPS_DEBUG_ST_ENUM, MIPS_DEBUG_ST_BLOCK, MIPS_DEBUG_ST_PROC, MIPS_DEBUG_ST_END, STB_LOCAL, STT_OBJECT, STV_DEFAULT, STB_GLOBAL, SHT_REL
